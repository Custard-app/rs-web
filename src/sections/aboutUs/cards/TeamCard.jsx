    ...
    <div className="w-full sm:w-[300px] h-[227px] sm:h-[400px] rounded-[20px] bg-white p-5 flex flex-col items-center gap-4">
      <div className='w-full flex items-start justify-between'>
        ...
        <div className='flex items-center gap-2'>
            <Link href={team.twitter}><FaTwitter size={20}/></Link>
            <Link href={team.linkedin}><FaLinkedin size={20}/></Link>
            
        </div>
      </div>
      <div className='w-full flex flex-row sm:flex-col items-center sm:justify-center gap-4'>
        <Image src={team.img} alt="Full name" className='w-[100px] sm:w-40 h-[100px] sm:h-40 object-cover rounded-full object-center'  />
