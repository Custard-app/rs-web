    ...
    <div className="bg-teal-900 overflow-hidden relative">
      <Width3XL>
        <div className="w-full flex flex-col items-center relative overflow-hidden pb-20">
          ...
          <button className="flex items-center bg-accentLime p-2 px-3 rounded-full mt-8 z-10">
      ...
      {/* Big Circle */}
      <div className="absolute right-[-10%] top-[2%] w-[1100px] h-[1100px] rounded-full border-[1px] opacity-25"></div>
      {/* Small Circle */}
      <div className="absolute right-[-6%] top-[25%] w-[850px] h-[850px] rounded-full border-[1px] opacity-25"></div>
