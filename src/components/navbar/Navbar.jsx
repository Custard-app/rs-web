        ...
        <div className="flex items-center justify-between py-5 px-5 sm:px-0 sm:py-5 relative">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button onClick={toggleHamburgerMenu} className='block sm:hidden'>
          ...
          <div
            className={`fixed inset-0 bg-[#151515] z-40 transition-transform transform ${
